...
public class KakaoPay {
    ...
    public String kakaoPayReady() {
        ...
        headers.add("Acept", MediaType.APPLICATION_JSON_UTF8_VALUE);
        ...
        try {
            reqkakao = restTemplate.postForObject(new URI(HOST + "/v1/payment/ready"), body, reqkakao.getClass());
    ...
    public KakaoPayApprovalDTO kakaoPayInfo(String pg_token) {
        ...
        try {
            apvkakao = restTemplate.postForObject(new URI(HOST + "/v1/payment/approve"), body, apvkakao.getClass());
            log.info("" + apvkakao);
